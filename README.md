# C++ Student Roster System

This is a command-line application built in C++ that demonstrates Object-Oriented Programming (OOP) principles to manage a student roster.
...
* **Reporting:** Includes functions to:
    * Print all students in a specific degree program.
    * Calculate and print the average number of days in a course for a specific student.
